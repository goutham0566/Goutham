...
// declaring the external variable
int x='e'; 

void autoStorageClass(auto int e);
...
void autoStorageClass(auto int e) //auto storage class
{ 
	// declaring an auto variable 
	//auto int a = 'a';

	// print auto variable 
	cout<<" Value of the auto variable : "<<e<<endl; 
	cout<<"--------------------------------"<<endl; 
} 
